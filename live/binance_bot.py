...
def run_live_bot(symbol='BTC/USDT', timeframe='1m', capital=100, stop_loss_pct=0.02, mode='paper'):
    ...
    amount = round(risk_amount / stop_distance, 6)  # use 95% of available balance
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the EMA trading bot live or in paper mode.")
